...
import umc.everyones.everyoneslckmanage.databinding.SpinnerInnerViewBinding
import umc.everyones.everyoneslckmanage.databinding.SpinnerOuterViewBinding

class MatchSpinnerAdapter(context: Context, private val list: List<String>?) :
    BaseAdapter() {
