...
class HomeFragment : BaseFragment<FragmentHomeBinding>(R.layout.fragment_home) {
    ...
    companion object{
        val navigateMenuMap = hashMapOf(
            Pair(R.id.tv_home_delete_post_content, R.id.action_homeFragment_to_delete_post_graph),
            Pair(R.id.tv_home_delete_comment_content, R.id.action_homeFragment_to_delete_comment_graph),
