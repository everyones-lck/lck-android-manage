...
class ViewingPartyDataSourceImpl @Inject constructor(
    ...
    override suspend fun getViewingPartyWithReportList(page: Int, size: Int): BaseResponse<ViewingPartyWithReportListResponseDto> =
        viewingPartyService.getViewingPartyWithReportList(page, size)
